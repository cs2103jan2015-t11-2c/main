...
/*void DataStore::entryType(std::string &subject, int &startTime, int &endTime, int &day, int &month, int &year, std::string &impt, std::string &category) {
	_tempEntry.index = index;
	_tempEntry.subject = subject;
	_tempEntry.startTime = startTime;
