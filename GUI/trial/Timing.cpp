...
//Assume that the task will take one hour if the user doesnt key in an end Timing
...
int Timing::countWord(std::string str) {
...
bool Timing::extractTime (std::string &line, int &noOfTime) {
	std::string str = line;
